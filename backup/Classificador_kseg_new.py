...
def unsupervised_ksegFit(X, k_max, alfa, lamda, outlier, buffer, curve_start, curve):
    
    if curve_start == False:
...
def supervised_ksegFit(X, Y, k_max, alfa, lamda, buffer, curve_start, curve):
    nclasses = Y.shape[1]
    j = 0
    parametros  = {}
